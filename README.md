...
```sh
./lifecycle/prepare.sh <DATA_PATH> [SOURCE_PATH] [STATE_PATH] [IGNORE_RETURN_VALUES]
```
...
| `STATE_PATH` | `mktemp -d` | Directory to persist SHA-256 state between runs (pass a stable path to enable caching) |
